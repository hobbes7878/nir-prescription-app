...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Drug_Stat.eng_total_items'
        db.delete_column(u'rx_drug_stat', 'eng_total_items')
    ...
    def backwards(self, orm):
        # Adding field 'Drug_Stat.eng_total_items'
        db.add_column(u'rx_drug_stat', 'eng_total_items',
    ...
    models = {
        ...
        u'rx.drug_stat': {
            ...
            'nir_top_drug': ('django.db.models.fields.CharField', [], {'max_length': '250'}),
