...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TopDrugGPs.action'
        db.add_column(u'rx_topdruggps', 'action',
                      self.gf('django.db.models.fields.CharField')(default='Antidepressant', max_length=250),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TopDrugGPs.action'
        db.delete_column(u'rx_topdruggps', 'action')
